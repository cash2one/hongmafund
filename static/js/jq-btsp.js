...
!function($) {
    ...
    $(function() {
        ...
        $("body").on("click.dropdown touchstart.dropdown.data-api", ".dropdown", function(e) {
            e.stopPropagation();
...
!function($) {
    ...
    Carousel.prototype = {cycle: function(e) {
            ...
            var $active = this.$element.find(".item.active"), $next = next || $active[type](), isCycling = this.interval, direction = type == "next" ? "left" : "right", fallback = type == "next" ? "first" : "last", that = this, e = $.Event("slide", {relatedTarget: $next[0]});
            this.sliding = true;
