...
$(this).hide(); 
var container = $("<div class='select_con'></div>").insertAfter(this)
$(this).data("cssobj",divselect); 
var divselect = $("<p></p>").appendTo(container).addClass("tag_select"); 
$(this).data("cssobj",divselect); 
var divoptions = $("<ul></ul>").appendTo(container).addClass("tag_options").hide(); 
...
$(this).next(".select_con").find("p").html($(this).children("option:eq("+ $(this)[0].selectedIndex +")").text()).addClass("tag_select"); 
}); 
