...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/ueditor/ImageUp/upimages/"             //图片上传提交地址
        ,imagePath:"/media/upimages/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/ueditor/ImageManager/upimages/"       //图片在线管理的处理地址
        ,imageManagerPath:"/media/upimages/"                                    //图片修正地址，同imagePath
